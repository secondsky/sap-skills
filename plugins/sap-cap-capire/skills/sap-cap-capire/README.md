...
CAP LSP support requires a Node runtime and `@sap/cds-lsp` installed on PATH. The bundled launcher fixes Windows npm `.cmd` shim resolution without bundling the SAP package.
